...
public class RadioMateriasController implements ActionListener {
	...
	JLabel lblId, lblNome, lblCarga, lblMaterias;
	JRadioButton rdbtnExclui, rdbtnAtualiza, rdbtnCadastro;
	JButton btnEnviar;
	JComboBox<Materias> comboBox;
	
	public RadioMateriasController(JTextField tfId, JTextField tfNome, JTextField tfCarga, JLabel lblId,
			JLabel lblNome, JLabel lblCarga, JLabel lblMaterias, JRadioButton rdbtnExclui, 
			JRadioButton rdbtnAtualiza, JRadioButton rdbtnCadastro, JButton btnEnviar, 
			JComboBox<Materias> comboBox) {
		 this.tfId = tfId;

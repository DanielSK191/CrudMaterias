...
public class MateriasDao implements IMateriasDao {
	...
	public void insereMaterias(Materias mat) throws SQLException {
		String sql = "INSERT INTO materias(id, nome, carga_horaria) VALUES (?,?,?)";
		PreparedStatement ps = c.prepareStatement(sql);
		ps.setInt(1, mat.getId());
		ps.setString(2, mat.getNome());
		ps.setInt(3, mat.getCarga());
		ps.execute();
		ps.close();
	}
	...
	public void excluiMaterias(Materias mat) throws SQLException {
		String sql = "DELET materias WHERE id = ?";
		PreparedStatement ps = c.prepareStatement(sql);
		ps.setInt(1, mat.getId());
		ps.execute();
		ps.close();
	...
	@Override
	public Materias consultaMaterias(Materias mat) throws SQLException {
